...
var TwitterTweet = (function (_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__extends)(TwitterTweet, _super);
    ...
    TwitterTweet.prototype.componentDidMount = function () {
        var _this = this;
        __webpack_require__(5277)('https://platform.twitter.com/widgets.js', 'tw', function () {
            if (!_this.mounted)
                return;
            if (!wnd.twttr) {
    ...
    TwitterTweet.prototype.render = function () {
        return this.props.renderWrap(react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { ref: "ref", className: blockClass }));
    };
    return TwitterTweet;
}(react__WEBPACK_IMPORTED_MODULE_0__.PureComponent));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TwitterTweet);
//# sourceMappingURL=index.js.map
