    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          html: '<img src="/zettelkasten/img/patreon-logo.png" alt="patreon-icon" width="20px" style="margin-top: 7px"/>',
        },
        {
          href: 'https://github.com/sponsors/sibelius',
          position: 'right',
          className: 'github-sponsor-logo',
          html: '<img src="/zettelkasten/img/gh-sponsor.svg" alt="github-sponsor-icon" width="25px" style="margin-top: 7px"/>',
        },
        {
          href: 'https://github.com/sibelius/zettelkasten',
          position: 'right',
          className: 'github-icon-header',
          html: '<img src="/zettelkasten/img/github-icon.svg" alt="github-icon" width="20px" />',
        },
      ],
    },
    colorMode: {
